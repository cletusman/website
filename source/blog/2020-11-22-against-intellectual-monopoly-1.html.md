...
<figure class="border-left ml-2 pl-3">
  <blockquote>
    <p>
      ...
      что подражатели (<i>примечание переводчика: cut-and-pasters</i>) не могут делать на законных
      основаниях с работой, защищённой авторским правом, - это напрямую
      копировать значительную её часть.
    </p>
  </blockquote>
</figure>
